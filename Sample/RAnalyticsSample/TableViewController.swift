...
enum GlobalConstants {
    ...
    static let kRATUrlSchemePathComponent = "URL Scheme Path Component"
    static let kRATUrlSchemeRef = "URL Scheme Ref"
    static let kRATUniversalLink = "Open Universal Link"
    static let kRATUniversalLinkPathComponent = "Universal Link Path Component"
    static let kRATUniversalLinkRef = "Universal Link Ref"
...
enum TableViewCellType: Int, CaseIterable {
    ...
    var title: String {
        ...
        case .urlSchemePathComponent:
            return GlobalConstants.kRATUrlSchemePathComponent
        case .urlSchemeRef:
            return GlobalConstants.kRATUrlSchemeRef
        case .universalLink:
            return GlobalConstants.kRATUniversalLink
        case .universalLinkPathComponent:
            return GlobalConstants.kRATUniversalLinkPathComponent
        case .universalLinkRef:
            return GlobalConstants.kRATUniversalLinkRef
...
class TableViewController: UITableViewController, BaseCellDelegate {
    ...
    private var urlSchemePathComponent: String?
    private var universalLinkPathComponent: String?
    private var urlSchemeRef: String?
    private var universalLinkRef: String?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch cellType {
        case .urlScheme:
            guard let url = model.urlScheme(appScheme: "demoapp", pathComponent: self.urlSchemePathComponent, ref: self.urlSchemeRef),
        ...
        case .universalLink:
            guard let url = model.universalLink(domain: Constants.domain, pathComponent: self.universalLinkPathComponent, ref: self.universalLinkRef),
                  UIApplication.shared.canOpenURL(url) else {
