...
final class ReferralAppModelSpec: QuickSpec {
    override class func spec() {
        describe("ReferralAppModel") {
            ...
            let refCustomParamItaly = "ref_custom_param1%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D=italy%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D"
            let refCustomParamRome = "ref_custom_param2%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D=rome%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D"
            ...
            describe("init(link:component:customParameters:)") {
                ...
                context("When bundleIdentifier is not nil") {
                    context("When RAT identifiers are configured") {
                        it("should return expected url scheme with minimal non-optional parameters") {
                            let model = ReferralAppModel(bundle: bundle)
                            expect(model?.urlScheme(appScheme: "app")?.absoluteString).to(
                                equal("app://?ref=jp.co.rakuten.Host&ref_acc=477&ref_aid=1"))
                        }
                    ...
                    context("When RAT identifiers are not configured") {
                        it("should return expected url scheme with RAT identifiers set to 1 and minimal non-optional parameters") {
                            ...
                            expect(model?.urlScheme(appScheme: "app")?.absoluteString).to(
                                equal("app://?ref=jp.co.rakuten.Host&ref_acc=0&ref_aid=1"))
                        }
                ...
                context("When RAT identifiers are configured") {
                    ...
                    it("should return expected url scheme with all expected parameters") {
                        ...
                        expect(urlScheme?.starts(with: "app://?ref=jp.co.rakuten.Host&ref_acc=477&ref_aid=1&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                        expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                        expect(urlScheme?.contains("custom_param2=tokyo")).to(beTrue())
                        expect(urlScheme?.contains(refCustomParamItaly)).to(beTrue())
                        expect(urlScheme?.contains(refCustomParamRome)).to(beTrue())
                    }
                    ...
                    it("should return expected universal link with all expected parameters") {
                        ...
                        expect(universalLink?.starts(with: "https://rakuten.co.jp?ref=\(bundleIdentifier)&ref_acc=477&ref_aid=1&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                        expect(universalLink?.contains("custom_param1=japan")).to(beTrue())
                        expect(universalLink?.contains("custom_param2=tokyo")).to(beTrue())
                        expect(universalLink?.contains(refCustomParamItaly)).to(beTrue())
                        expect(universalLink?.contains(refCustomParamRome)).to(beTrue())
                    }
                }
                ...
                context("When RAT identifiers are not configured") {
                    ...
                    it("should return expected url scheme with RAT identifiers and all expected parameters") {
                        let urlScheme = model?.urlScheme(appScheme: "app")?.absoluteString
                        expect(urlScheme?.starts(with: "app://?ref=jp.co.rakuten.Host&ref_acc=0&ref_aid=1&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                        expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                        expect(urlScheme?.contains("custom_param2=tokyo")).to(beTrue())
                        expect(urlScheme?.contains(refCustomParamItaly)).to(beTrue())
                        expect(urlScheme?.contains(refCustomParamRome)).to(beTrue())
                    ...
                    it("should return expected universal link with RAT identifiers and all expected parameters") {
                        let universalLink = model?.universalLink(domain: "rakuten.co.jp")?.absoluteString
                        expect(universalLink?.starts(with: "https://rakuten.co.jp?ref=\(bundleIdentifier)&ref_acc=0&ref_aid=1&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
            ...
            describe("init(accountIdentifier:applicationIdentifier:link:component:customParameters:)") {
                ...
                it("should return expected url scheme and expected universal link with minimal non-optional parameters") {
                    let model = ReferralAppModel(accountIdentifier: accountIdentifier,
                                                 applicationIdentifier: applicationIdentifier)
                    expect(model?.urlScheme(appScheme: "app")?.absoluteString).to(equal("app://?ref=jp.co.rakuten.Host&ref_acc=1&ref_aid=2"))
                ...
                it("should return expected url scheme and expected universal link with all parameters") {
                    let model = ReferralAppModel(accountIdentifier: accountIdentifier,
                                                 ...
                                                 bundle: Bundle.main)
                    let urlScheme = model?.urlScheme(appScheme: "app")?.absoluteString
                    expect(urlScheme?.starts(with: "app://?ref=jp.co.rakuten.Host&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                    expect(urlScheme?.contains("custom_param2=tokyo")).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamItaly)).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamRome)).to(beTrue())
                    ...
                    let universalLink = model?.universalLink(domain: "rakuten.co.jp")?.absoluteString
                    expect(universalLink?.starts(with: "https://rakuten.co.jp?ref=\(bundleIdentifier)&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(universalLink?.contains("custom_param1=japan")).to(beTrue())
                    expect(universalLink?.contains("custom_param2=tokyo")).to(beTrue())
                    expect(universalLink?.contains(refCustomParamItaly)).to(beTrue())
                    expect(universalLink?.contains(refCustomParamRome)).to(beTrue())
            ...
            describe("urlScheme(appScheme:, pathComponent:)") {
                ...
                it("should return the expected URL without path component") {
                    let urlScheme = model.urlScheme(appScheme: "app")?.absoluteString
                    expect(urlScheme?.starts(with: "app://?ref=jp.co.rakuten.Host&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                    expect(urlScheme?.contains("custom_param2=tokyo")).to(beTrue())
                ...
                it("should return the expected URL with path component equal nil") {
                    let urlScheme = model.urlScheme(appScheme: "app", pathComponent: nil)?.absoluteString
                    expect(urlScheme?.starts(with: "app://?ref=jp.co.rakuten.Host&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamItaly)).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamRome)).to(beTrue())
                    expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                ...
                it("should return the expected URL with path component") {
                    let urlScheme = model.urlScheme(appScheme: "app", pathComponent: "path/to/resource")?.absoluteString
                    expect(urlScheme?.starts(with: "app:///path/to/resource?ref=jp.co.rakuten.Host&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamItaly)).to(beTrue())
                    expect(urlScheme?.contains(refCustomParamRome)).to(beTrue())
                    expect(urlScheme?.contains("custom_param1=japan")).to(beTrue())
                    expect(urlScheme?.contains("custom_param2=tokyo")).to(beTrue())
            ...
            describe("universalLink(domain:, pathComponent:)") {
                ...
                it("should return the expected URL with path component equal nil") {
                    let universalLink = model.universalLink(domain: "rakuten.co.jp", pathComponent: nil)?.absoluteString
                    expect(universalLink?.starts(with: "https://rakuten.co.jp?ref=\(bundleIdentifier)&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(universalLink?.contains(refCustomParamItaly)).to(beTrue())
                    expect(universalLink?.contains(refCustomParamRome)).to(beTrue())
                    expect(universalLink?.contains("custom_param1=japan")).to(beTrue())
                ...
                it("should return the expected URL with path component") {
                    let universalLink = model.universalLink(domain: "rakuten.co.jp", pathComponent: "path/to/resource")?.absoluteString
                    expect(universalLink?.starts(with: "https://rakuten.co.jp/path/to/resource?ref=\(bundleIdentifier)&ref_acc=1&ref_aid=2&ref_link=campaignCode%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D&ref_comp=news%253A%2523%255B%255D%2540%2521%2524%2526%2527%2528%2529%252A%252B%252C%253B%253D")).to(beTrue())
                    expect(universalLink?.contains(refCustomParamItaly)).to(beTrue())
                    expect(universalLink?.contains(refCustomParamRome)).to(beTrue())
                    expect(universalLink?.contains("custom_param1=japan")).to(beTrue())
                    expect(universalLink?.contains("custom_param2=tokyo")).to(beTrue())
