...
struct DelayedValue<T> {
    ...
    /// This is only used to widen the overlap window between two concurrent operations.
    /// Keep it small so tests remain fast and stable in CI.
    private let delaySeconds = 0.001
