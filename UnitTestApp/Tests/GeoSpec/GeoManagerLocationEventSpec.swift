...
struct GeoManagerLocationEventSpec {
    ...
    func testRequestLocationCallsCLLocationManager() async throws {
        ...
        let geoLocationManager = GeoLocationManager(
            ...
            configurationStore: GeoManagerLocationEventSpec.configurationStore)
    ...
    private func setupLocationTest(actionParameters: GeoActionParameters?, location: CLLocation? = nil) async throws -> (GeoRequestLocationResult?, TrackerMock) {
        ...
        coreLocationManagerMock.delegate?.locationManager?(GeoManagerLocationEventSpec.coreLocationManager, didUpdateLocations: [testLocation])
    ...
    private func setupErrorTest(expectedError: NSError) async throws -> (GeoRequestLocationResult?, TrackerMock) {
        ...
        coreLocationManagerMock.delegate?.locationManager?(GeoManagerLocationEventSpec.coreLocationManager, didFailWithError: expectedError)
