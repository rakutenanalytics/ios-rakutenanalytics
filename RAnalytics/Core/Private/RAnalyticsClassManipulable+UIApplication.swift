...
extension UIApplication: RAnalyticsClassManipulable, RuntimeLoadable {
    ...
    @objc public static func loadSwift() {
        replaceMethod(#selector(setter: delegate),
                      ...
                      onlyIfPresent: true)
        RLogger.verbose("Installed auto-tracking hooks for UIApplication")
    }
    ...
    @objc func r_autotrack_application(
        ...
        _RAnalyticsLaunchCollector.sharedInstance().setOrigin(.internal)
    ...
    @objc func r_autotrack_application(_ application: UIApplication, handleOpen url: URL) -> Bool {
        ...
        _RAnalyticsLaunchCollector.sharedInstance().setOrigin(.external)
    ...
    @objc func r_autotrack_application(_ application: UIApplication,
        ...
        _RAnalyticsLaunchCollector.sharedInstance().handleTapNonUNUserNotification(
            userInfo,
    ...
    @objc func r_autotrack_setApplicationDelegate(_ delegate: UIApplicationDelegate?) {
        ...
        RLogger.verbose("Application delegate is being set to \(String(describing: delegate))")
...
// To be removed once _RAnalyticsLaunchCollector is migrated to Swift
extension _RAnalyticsLaunchCollector {
    func setOrigin(_ origin: AnalyticsManager.State.Origin) {
        setValue(origin.rawValue, forKey: "origin")
    }
}
