...
{
    [RLogger verbose:@"Application will finish launching with options = %@", launchOptions];
...
{
    [RLogger verbose:@"Application did finish launching with options = %@", launchOptions];
...
{
    [RLogger verbose:@"Application was asked to open URL %@ with options = %@", url.absoluteString, options];
...
{
    [RLogger verbose:@"Application was asked by %@ to open URL %@ with annotation %@", sourceApplication, url.absoluteString, annotation];
...
{
    [RLogger verbose:@"Application delegate is being set to %@", delegate];
