            ...
            describe("process(event:state:)") {
                ...
                context("When the event is loc") {
                    ...
                    func verifyAutomaticFields(json: [String: Any], expectedLtm: String, expectedTs1: Double) {
                        ...
                        expect(json[PayloadParameterKeys.Telephony.mcn] as? String).to(beEmpty())

                        expect(json[PayloadParameterKeys.Telephony.mcnd] as? String).to(beEmpty())
                        ...
                        expect(json[PayloadParameterKeys.Telephony.simopn] as? String).to(beNil())

                        expect(json[PayloadParameterKeys.Telephony.simop] as? String).to(beNil())
